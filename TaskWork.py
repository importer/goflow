...
class BaseTaskRunner(object):
    ...
    def _read_task_log(self, stream):
        while True:
            ...
            if len(line) == 0:
                break
            # log.logger.info('{}-{}-{}-{}'.format(self.task_instance.task_id,
            #                                               self.task_instance.id,
            #                                               self.task_instance.etl_day,
            #                                               line))
        self.task_instance.result=self.result    
    ...
    def inner_run(self, runner, times):
        ...
        for x in ["run"]:
            ...
            try:
                ...
                log.logger.error("get exeception {}.{}".format(type(e), str(e)))
                msg = "get Exception: {}".format(str(e))
            finally:
...
class Worker(object):
    ...
    def __init__(self, **configs):
        ...
        self.running_worker = []
        self.task_name='bi_scheduler_dispatch'
        ...
        while True:
            ...
            try:
                ...
                while producer.llen(self.task_name):
                    msg = producer.rpop(self.task_name)#这里可以用StrictRedis实例的brpop改善，去掉llen轮询。
                    # print(msg)
                    try:
                        ...
                        msg = "{} run instance {}, execption:{},{}".format(node_info, instance_msg, type(e), str(e))
                        log.logger.error(msg)
                        process_utils.Alert(msg)
                else:
                ...
                alert_msg = "{}, get exception  {}, {} ".format(node_info, type(e), str(e))
...
def main():
    config.setupConf('cflow_conf.json')
